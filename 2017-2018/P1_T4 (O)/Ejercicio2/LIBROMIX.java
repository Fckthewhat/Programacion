package Arraysentrenamientobidimensionales;
	...
	public static void main(String[] args) {
		...
		for(int fila = 0;fila<cantVentas.length;fila++) {
			for(int columna = 0;columna<cantVentas[fila].length;columna++){
				...
				cantVentas[fila][columna] = sc.nextInt();
			}
		}
		...
		for(int cont = 0;cont<cantVentas[0].length;cont++)
			System.out.println("En la caseta nº"+(cont+1)+" se han vendido "
					+cantVentas[5][cont]+" ejemplares.");
