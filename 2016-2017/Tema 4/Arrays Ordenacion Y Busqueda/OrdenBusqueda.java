...
public class OrdenBusqueda {
	...
	public static void seleccion(int[]array){ //array seleccion
		
	System.out.println("****Array selección****");
		int min=0,i,j,aux;
	...
	public static void intercambio (int[]array){ //array intercambio
		System.out.println("****Array intercambio****");
		int aux,i,j;
	...
	public static void burbuja (int[]array){ //array burbuja
		System.out.println("****Array Burbuja****");
		int aux,i,j;
	...
	public static int burbujamejorado(int[]array){ //array burbuja mejorado
		System.out.println("****Array burbuja mejorado****");
		int aux,i,j,num=0;
	...
	public static int busquedaSecuencialOrdenada(int []array, int n){
		System.out.println("****Array busqueda secuencial/lineal****");
		intercambio(array);
		int posicion=-1,i;
	...
	public static int busquedaSecuencialDesordenada(int []array, int n){
		System.out.println("****Array busqueda secuencial desordenada****");
		int posicion=-1,i;
		for(i=0;i<array.length-1;i++){
			if(array[i]==n)
				return i; 
	...
	public static int busquedaBinaria(int[]array,int valor){
		System.out.println("****Array busqueda binaria****");
